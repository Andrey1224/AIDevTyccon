...
- **Cross-Agent Compatibility**: Centralized guidelines live in [AGENTS.md](file:///Users/andriinepodymka/Desktop/AIDevTyccon/ai-dev-tycoon/AGENTS.md). Other AI tools are routed to this source of truth via short root-level proxy instruction files (`CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.agents/AGENTS.md`).
